		...
		<main className="formPage">
			...
			<div className="content">
				...
				<p>
					...
					licença permite que qualquer pessoa:
				</p>
				<ul>
				...
				<p>
					...
					<a href="https://github.com/0cto-dev/octodev">repositório do OctoDev</a>.
				</p>
				...
				<p>
					...
					modificações significativas por meio da plataforma ou por e-mail. Recomendamos revisar estes termos
