...
async function getLesson(course: string, id: string): Promise<lessonType> {
	try {
		...
		console.log(error)
		console.log('Voce esta numa versão de teste, provavelmente clonou o repositorio do github, certo? experimente criar seus proprios exercicios, criando uma pasta chamada "data" na raiz do projeto e faça o seguinte aninhamento: date>practice>[nome do curso que deseja criar os exercicios]/lessons.json, caso precise de uma base, aqui está:')
